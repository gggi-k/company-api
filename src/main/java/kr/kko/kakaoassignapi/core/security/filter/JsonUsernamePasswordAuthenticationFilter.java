package kr.kko.kakaoassignapi.core.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import kr.kko.kakaoassignapi.core.security.dto.Login;
...
public class JsonUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            validator.validate(login, Default.class);
            UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(login.getEmployeeId(), login.getPassword());
